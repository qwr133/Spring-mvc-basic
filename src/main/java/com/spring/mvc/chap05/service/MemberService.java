...
public class MemberService {
    ...
    //중복검사 서비스 처리 -- 중복이면 true, 아니면 false
    ...
    public void maintainLogiState(HttpSession session, String account) {
        ...
        //현재 고르인 한 사람의 화면에 보여줄 일부 정보=dto
